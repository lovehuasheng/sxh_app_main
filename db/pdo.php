...
class MMysql {
    ...
    public function __construct() {
        ...
        if($db_conf){
            $this->_host = $db_conf['hostname'];
            $this->_port = $db_conf['hostport'] ? $db_conf['hostport'] : $this->_port;
            $this->_user = $db_conf['username'];
            $this->_pass = $db_conf['password'];
            $this->_dbName = $db_conf['database'];
        }
